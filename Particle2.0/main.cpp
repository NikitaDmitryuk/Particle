...
int main(int argc, char *argv[])
{
    ...
    runManager.setInizialization(new Colloid(0, "Colloid", Vector3d (0.0, 0.0, 0.0), new Shape(2.0), new Material(2.95)));
    runManager.setInizialization(new Colloid(1, "Colloid", Vector3d (2.01, 0.0, 0.0), new Shape(2.0), new Material(2.95)));
